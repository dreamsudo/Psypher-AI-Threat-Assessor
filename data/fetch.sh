...
echo "[fetch] MITRE ATT&CK ICS (STIX) -> attack-stix-data/"
curl -fsSL -o attack-stix-data/ics-attack.json \
  "https://raw.githubusercontent.com/mitre-attack/attack-stix-data/master/ics-attack/ics-attack.json"
echo "[fetch] MITRE ATT&CK Mobile (STIX) -> attack-stix-data/"
curl -fsSL -o attack-stix-data/mobile-attack.json \
